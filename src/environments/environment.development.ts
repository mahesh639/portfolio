export const environment = {
    ...
    experienceNotes: [
        ...
        "Contributed to providing software solutions to clients with optimum client satisfaction.",
        "Implemented functionalities to handle various data requests (CRUD operations) and business logic.",
        "Provided proactive solutions while solving bugs and issues to meet client’s requirements.",
        "Developed and implemented a scalable Rest API using ASP.NET Web API.",
        "Developed and maintained full-stack web applications using Angular, ASP.NET Core, and SQL.",
        "Improved application performance by optimizing database queries and refactoring inefficient code blocks.",
        "Worked on full-stack projects from scratch requiring expertise in Angular and ASP.NET with SQL."
    ],
